...
this is information in which can be used maybe along with another program to make use of it fully but this is a solid barebones way of getting this infor you can also set include and exclude if you have more experience and are searching for spefics even more and this can be used to help reverse engineer firmware
